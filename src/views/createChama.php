<div class="flex h-screen">
    <div class="flex flex-1 md:flex-row flex-col items-center justify-end px-4 py-12 sm:px-6 lg:px-20 xl:px-24 mx-auto">
        <div class="mx-auto space-y-2">
            ...
            <h2 class="text-xl font-medium leading-9 tracking-tight text-gray-900">Create your own chama</h2>
