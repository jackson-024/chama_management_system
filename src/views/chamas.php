...
echo $table->TableData($chamas, [
    function ($data) {
        return '<a href="chama-profile?id=' . $data["id"] . '" class="cursor-pointer block rounded-md px-3 py-2 text-center text-sm font-semibold text-indigo-600 shadow-sm ring-1 ring-indigo-600 hover:bg-indigo-600 hover:text-white">
        Profile
    </a>';
    }
], $rowStyles);
